...
* Suppose we want to test the association between social disorganization and violent victimization. We gather data on 41 low-SES neighborhoods and find that the mean number of victimizations in the last year is 12.4 ($\sigma^{2}$ = 18.49). We also gather data on 21 high-SES neighborhoods and find that the mean number of We also gather data on 21 high-SES neighborhoods and find that the mean number of victimizations is 5.2 ($\sigma^{2}$ = 2.25). Our research question is: Do people that live in low-SES neighborhoods have a different risk of victimization than people that live in high-SES neighborhoods? Use $\alpha$ = .01. 
    ...
    3. *Make decision rules*: $\alpha$=.01 (two-tailed), $z_{crit}=$, reject $\text{H}_{0}$ if |TS|>. 
    \vspace{2pt}
...
\vspace{3pt}
    ...
    \vspace{2pt}
    4. *Calculcate the test statistic*: $\displaystyle t=\frac{(\overline{\text{x}}_{1}-\overline{\text{x}}_{2})}{\sqrt{\frac{\sigma^{2}_{1}}{\text{n}_{1}-1}+\frac{\sigma^{2}_{2}}{\text{n}_{2}-1}}}$ = $\displaystyle \frac{3.73-2.22}{\sqrt{\frac{12.95}{2243-1}+\frac{8.19}{6679-1}}}$ = `r format((3.73-2.22)/((sqrt((12.95/(2243-1))+(8.19/(6679-1))))),nsmall=3,digits=3)`
...
\vspace{2pt}
4. *Calculcate the test statistic*: $\displaystyle t=\frac{(\overline{\text{x}}_{1}-\overline{\text{x}}_{2})}{\sqrt{\frac{\sigma^{2}_{1}}{\text{n}_{1}-1}+\frac{\sigma^{2}_{2}}{\text{n}_{2}-1}}}$ = $\displaystyle \frac{5.9-2.8}{\sqrt{\frac{5.29}{10-1}+\frac{5.36}{10-1}}}$ = `r format((5.9-2.8)/((sqrt((5.29/(10-1))+(5.36/(10-1))))),nsmall=3,digits=3)`
...
1. *Formally state hypotheses*: $\text{H}_{1}:\mu_{N} < \mu_{D} \therefore \mu_{N}-\mu_{D} < 0$; $\text{H}_{0}:\mu_{N} = \mu_{D} \therefore \mu_{N}-\mu_{D} \ge 0$ 
...
\vspace{2pt}
4. *Calculcate the test statistic*: $\displaystyle t=\frac{(\overline{\text{x}}_{1}-\overline{\text{x}}_{2})}{\sqrt{\frac{\sigma^{2}_{1}}{\text{n}_{1}-1}+\frac{\sigma^{2}_{2}}{\text{n}_{2}-1}}}$ = $\displaystyle            \frac{1.67-2.38}{\sqrt{\frac{1.21}{6-1}+\frac{2.46}{8-1}}}$ = `r format((1.67-2.38)/((sqrt((1.21/(6-1))+(2.46/(8-1))))),nsmall=3,digits=3)`
